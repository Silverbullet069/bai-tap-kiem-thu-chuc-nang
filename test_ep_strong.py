...
class TestStrongEquivalencePartitioning(unittest.TestCase):
    ...
    def test_3(self):
        time = Time(11, 59, 29)
        self.assertEqual(time.get_next_second(), '11:59:30')
    ...
    def test_5(self):
        time = Time(23, 29, 29)
        self.assertEqual(time.get_next_second(), '23:29:30')

    def test_6(self):
        time = Time(23, 29, 59)
        self.assertEqual(time.get_next_second(), '23:30:00')

    def test_7(self):
        time = Time(23, 59, 29)
        self.assertEqual(time.get_next_second(), '23:59:30')
